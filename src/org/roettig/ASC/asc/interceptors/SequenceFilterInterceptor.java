...
public class SequenceFilterInterceptor implements ASAFlowInterceptor
{
	@Override
	...
	protected static PairwiseAlignment pwa = new PairwiseAlignment();
	
	public static double align(Sequence x, Sequence y)
	{
		double pid = 0.0;
		try
		{
