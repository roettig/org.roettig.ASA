...
public class ASCpredict
{
	...
	public static void main(String[] args) throws Exception
	{
		...
		Map<String,Double> precs = jd.getPrecs();
		Map<String,Double> recs  = jd.getRecs();
		for(String k: precs.keySet())
		{
			System.out.println("## "+ k );
			System.out.println(String.format(Locale.ENGLISH,"prec=%.3f rec=%.3f",precs.get(k),recs.get(k)));
		}
